...
void ButtonEvents::attach(SX1509* io, int pin) {
  debouncedButton.attach(io, pin);
}

// passthru to Bounce2 attach() overload
void ButtonEvents::attach(SX1509* io, int pin, int mode) {
  debouncedButton.attach(io, pin, mode);
}
